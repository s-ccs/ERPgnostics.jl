...
# ╔═╡ 60347e91-8f56-4309-acdc-a2a8d45f6038
begin
    using Pkg
...
# ╔═╡ 23006671-f885-47e2-80a9-fd0ba8ef176d
data_epoch_raw
...
plot_erpimage(data_epoch[32, :, :], sortvalues = events_epoch.duration)
...
let
    ...
    for i = 1:3
        for j = 1:3
            ...
            plot_erpimage!(
                f[i, j],
                data_epoch[ixlist[ix], :, :],
                axis = (; title = "Channel $(ix)"),
            )
        end
    end
    f
    ...
    for i = 1:3
        for j = 1:3
            ...
            plot_erpimage!(
                ...
                data_epoch[ixlist[ix], :, :],
                axis = (; title = "Channel $(ix)"),
                sortvalues = events_epoch.duration,
            )
        end
    end
    f
