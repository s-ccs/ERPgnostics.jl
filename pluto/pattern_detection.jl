...
# ╔═╡ 10294d44-558e-4831-aaef-fd36475fff28
md"""
Loading of libraries
"""

# ╔═╡ 93a00283-146c-49cb-8734-c21e9c41485c
md"""
Data simulation
"""
...
md"""
Data visualisation.
This type of ERP visualisation is called ERP image
"""

# ╔═╡ d68e61b8-4a64-4396-96c3-f8bd95ee42b8
plot_erpimage(times, dat_e; sortvalues = evts.Δlatency)

# ╔═╡ 95296df2-e885-4a97-94db-8ee3dd9b45d0
md"""
Normalisation of data to get read of vertical bar.
"""
...
# ╔═╡ 4ccd1f1a-8b6a-4beb-a8d8-52219ac568be
md"""
On the pictures above you can see a line and distribution.
...
# ╔═╡ 3c29b22e-b41f-40ab-98b1-a8cdbbeed033
entropy([0, 0, 0, 1, 1, 1])


# ╔═╡ f349f28d-0e9a-4fcc-b6cd-0b49f58d0374
entropy([0, 0, 0, 0, 0, 0])
...
# ╔═╡ 55c3cf3c-b359-4171-a3fa-1932c4ac930d
md"""
In general, the data with a pattern should have lower entropy. This is because data with a pattern or structure is more predictable and organized, leading to less uncertainty and randomness, which results in lower entropy values. On the other hand, data without a pattern tends to be more unpredictable and random, leading to higher entropy values.
"""

# ╔═╡ 24ab4454-c559-4cd7-a5b3-1164e18bfd11
md"""
### Minmax
"""
...
# ╔═╡ f7d2121e-904e-4302-ab65-6047a5e1d84d


# ╔═╡ 6eeee1f2-0bc7-4e3a-b898-b46c5730ab22
...
manifest_format = "2.0"
project_hash = "f2eb42350e57e0eaa38adee474df5c04eb7de6f8"
...
git-tree-sha1 = "3e5bd6b4a43a1de21f21faa4a309501c14da58bc"
